		...
		if not (who) or not (minutes) or not (...) or (minutes<1) then
			...
			if commandName ~= "sojail" then
				if (hiddenAdmin==0) then
					...
					outputChatBox("OfflineJail: " .. adminTitle .. " " .. playerName .. " ("..adminUsername..") jailed " .. accountUsername .. " for " .. minutes .. " minutes.", getRootElement(), 255, 0, 0)
					outputChatBox("OfflineJail: Reason: " .. reason, getRootElement(), 255, 0, 0)
				else
					outputChatBox("OfflineJail: Hidden Admin jailed " .. accountUsername .. " for " .. minutes .. " minutes.", getRootElement(), 255, 0, 0)
					outputChatBox("OfflineJail: Reason: " .. reason, getRootElement(), 255, 0, 0)
				end
			end
