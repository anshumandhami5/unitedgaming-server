...
local playernames = {["Josh_Paddington"]=true, ["Paul_Trevor"]=true, ["Holly_Parker"]=true, ["Jennifer_Lopez"]=true, ["Justin_Timberlake"]=true, ["Danny_Parker"]=true, ["Socialz"]=true, ["Pamela_Parkinson"]=true }
local debugs = false
